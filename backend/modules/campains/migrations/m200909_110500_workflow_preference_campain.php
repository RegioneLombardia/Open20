...
/**
 * Class m200909_110500_workflow_preference_campain
 */
class m200909_110500_workflow_preference_campain extends AmosMigrationWorkflow
{
    ...
    private function workflowMetadataConf()
    {
        return [
            ...
            [
                ...
                'key' => 'description',
                'value' => 'Da approvare, campagna in modifica'
            ],
