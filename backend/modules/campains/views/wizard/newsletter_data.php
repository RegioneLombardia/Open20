...
<div class="heading border-bottom mb-4 pb-2">
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="mb-0 pr-2 text-muted text-uppercase">Nuova campagna: mail (dati generali)</h3>
        </div>
        <div>
...
<div class="preference-campain-step-2">
    ...
    ?>  
        ...
        <!-- START Form Content -->
        <?= 
            $this->render('_parts/_form_newsletter_detail', [
                'form' => $form,
                'model' => $model,
                'template' => $template,
                'fid' => NULL,
        ...
        <div class="d-flex justify-content-between mt-5">
                    ...
                    <?= Html::a('Precedente', ['/campains/wizard/create-campain/?id='.$model->preference_campain_id], ['class'=>'btn btn-primary']) ?>
