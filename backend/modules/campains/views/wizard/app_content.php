...
$this->title = Yii::t('amoscore', 'STEP 6', [
...
<div class="heading border-bottom mb-4 pb-2">
    <div class="d-flex align-items-center">
        <div class="mr-auto">
	            <h3 class="mb-0 pr-2 text-muted text-uppercase"><?=Yii::t('amoscore', 'Nuova campagna: App (struttura)')?></h3>
        </div>
        <div>
...
<div class="newsletter-content">
    ...
    ?>  
        ...
        <!-- FORM CONTENT -->
        <?= 
            $this->render('_parts/_form_app_content', [
                'model' => $model,
               // 'form' => $form,
        ...
        <div class="d-flex justify-content-between mt-5">
            ...
            <?= Html::a('Precedente', ['/campains/wizard/app-data/?id='.$model->id], ['class'=>'btn btn-primary']) ?>
            ...
            <div class="modal-body">
                ...
                <?php 
                    $form = ActiveForm::begin([
                        ...
                        'action' =>['/campains/wizard/create-app-container?id='.$model->id]
                    ]); 
                ?>  
                    ...
                    ?>
                    <?= 
                        $this->render('_parts/_form_app_container_content', [
                            'form' => $form,
                        ...
                        ?>  
                            ...
                            <?php 
                                ...
                                if( $container->preference_campain_container_type_id == 
                                    ...
                                    echo $this->render('_parts/_form_app_container_content', [
                                        'form' => $form,
                                        'model' => $container,
                                        'model_preference_campain' => $model,
                                        'type_content_align' => $type_content_align,
                                ...
                                if( $container->preference_campain_container_type_id == 
                                    ...
                                    echo $this->render('_parts/_form_app_external_content', [
                                        'form' => $form,
                                        'model' => $container,
                                        'model_preference_campain' => $model,
                                        'external_source' => $external_source,
