...
<div class="newsletter-content">
    ...
    <?php ActiveForm::end(); ?>
        ...
        <!-- FORM CONTENT -->
        <?= 
            $this->render('../wizard/_parts/_form_app_content', [
                'model' => $model,
                'form' => $form,
            ...
            <div class="modal-body">
                ...
                <?php 
                    $form = ActiveForm::begin([
                        ...
                        'action' =>['/campains/preference-campain/create-app-container?id='.$model->id]
                    ]); 
                ?>  
                    ...
                    ?>
                    <?= 
                        $this->render('../wizard/_parts/_form_app_container_content', [
                            'form' => $form,
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ?>  
                    ...
                    ?>
                    <?= 
                        $this->render('../wizard/_parts/_form_app_external_content', [
                            'form' => $form,
                            'model' => $preference_campain_container,
                            'model_preference_campain' => $model,
                        ...
                        ?>  
                            ...
                            <?php 
                                ...
                                if( $container->preference_campain_container_type_id == 
                                    ...
                                    echo $this->render('../wizard/_parts/_form_app_container_content', [
                                        'form' => $form,
                                        'model' => $container,
                                        'model_preference_campain' => $model,
                                        'type_content_align' => $type_content_align,
                                ...
                                if( $container->preference_campain_container_type_id == 
                                    ...
                                    echo $this->render('../wizard/_parts/_form_app_external_content', [
                                        'form' => $form,
                                        'model' => $container,
                                        'model_preference_campain' => $model,
                                        'external_source' => $external_source,
