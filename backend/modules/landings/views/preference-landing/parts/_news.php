...
$landingModel = $model;
    echo Html::a(\Yii::t('amosevents', 'Aggiungi Info'),
        ['/news/news/create','urlRedirect' => '/landings/preference-landing/update?id='.$model->id],
...
//            ],
            ...
            'news_groups_id' => [
                'attribute' => 'newsGroups.name',
                'label' => AmosEvents::t('amosnews', 'Gruppo')
            ],
            [
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) use ($landingModel) {
                        $url = ['/news/news/update','id' => $model->id,'urlRedirect' => '/landings/preference-landing/update?id=' . $landingModel->id];
                    ...
                    'view' => function ($url, $model) use ($landingModel) {
                        $url = ['/news/news/view','id' => $model->id,'urlRedirect' => '/landings/preference-landing/update?id=' . $landingModel->id];
                        $spriteAsset = BootstrapItaliaCustomSpriteAsset::register($this);
                    ...
                    'delete' => function ($url, $model) use ($landingModel){
                        $url = ['/news/news/delete', 'id' => $model->id, 'urlRedirect' =>'/landings/preference-landing/update?id=' . $landingModel->id];
                        $spriteAsset = BootstrapItaliaCustomSpriteAsset::register($this);
