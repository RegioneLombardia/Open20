...
$this->title = Yii::t('amoscore', 'Preference Landing Link');
$this->params['breadcrumbs'][] = ['label' => '', 'url' => ['/landings']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="preference-landing-link-index">
   ...
   'columns' => [
        ['class' => 'yii\grid\SerialColumn'],
                    ...
                    'preference_landing_id',
                        ...
                        'preferenceLanding' => [
                        'attribute' => 'preferenceLanding',
                        'format' => 'html',
                        'label' => '',
                        'value' => function($model){
                        return strip_tags($model->preferenceLanding);
                        }
                        ],
                                'sort_value',
            'title',
