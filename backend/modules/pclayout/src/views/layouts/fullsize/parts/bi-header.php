    ...
    if (!empty(\Yii::$app->params['disableMenuUser']) && \Yii::$app->params['disableMenuUser'] == true) {
        ...
        $menuMyProfile = Html::tag(
            ...
            Html::a(
                ...
                ['/operators/operator/update', 'id' => CurrentUser::getUserProfile()->id],
                [
                    'class' => 'list-item',
                    ...
                    <div class="it-header-slim-wrapper-content d-flex align-items-center">
                        ...
                        <div class="it-header-slim-right-zone ml-auto">
                            ...
                            <?php if (\Yii::$app->getModule('chat')) : ?>
                                ...
                                ?>
                                <div class="nav-item">
                                    <a class="nav-link" href="/messages" data-toggle="tooltip" data-placement="bottom" title="<?= AmosChat::t(
                                                                                                                                    'amoschat',
                                                                                                                                    'Messaggi privati'
                                                                                                                                )
                                                                                                                                ?>">
                            ...
                            <?php if (\Yii::$app->getModule('myactivities') && !\Yii::$app->user->isGuest && false) : ?>
                                <?php
                                ...
                                ?>
                                <div class="nav-item">
                                    <a class="nav-link" href="/myactivities/my-activities/index" data-toggle="tooltip" data-placement="bottom" title="<?= AmosMyActivities::t(
                                                                                                                                                            'amosmyactivities',
                                                                                                                                                            'My activities'
                                                                                                                                                        )
                                                                                                                                                        ?>">
                            ...
                            <div class="nav-item dropdown menu-translation mr-1">
                                <a class="nav-link dropdown-toggle" href="#" id="dropdownMenuTranslation" data-toggle="dropdown" aria-expanded="false">
                                    <?= $actualLang ?>
                            ...
                            <?php if (isset(\Yii::$app->params['toFrontendLink']) && \Yii::$app->params['toFrontendLink']) : ?>
                                <div class="nav-item">
                                    <a class="nav-link" href="<?= \Yii::$app->params['platform']['frontendUrl'] ?>" title="<?= Yii::t(
                                                                                                                                'amoscore',
                                                                                                                                '#frontend'
                                                                                                                            )
                            ...
                            <?php if (!CurrentUser::getUserIdentity()) : ?>
                                <div class="nav-item">
                                    <a class="nav-link" href="/site/login" title="<?= Yii::t('amoscore', 'Login') ?>"><?= Yii::t('amoscore', 'Login') ?></a>
                                </div>
                            <?php else : ?>
                                <div class="dropdown menu-profile">
                                    <a href="#" class="btn btn-primary btn-icon btn-full dropdown-toggle" role="button" id="dropdownMenuProfile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span class="rounded-icon">
                                            <img class="icon icon-primary rounded-circle" src="<?= $userImage ?>" alt="<?= $userNomeCognome ?>">
                                        </span>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <nav class="navbar pr-0">
                                <a class="icon-menu" data-toggle="collapse" href="#sidebarLeftMenu" role="button" aria-expanded="true" aria-controls="sidebarLeftMenu">
                                    <svg class="icon">
