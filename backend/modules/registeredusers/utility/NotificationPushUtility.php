...
namespace backend\modules\registeredusers\utility;
...
// VarDumper::dump( json_encode($result), $depth = 10, $highlight = true); 
                   // throw new Exception("Risultato notifica " . json_encode($result));
                }
            }
            // die;
            $ret = true;
