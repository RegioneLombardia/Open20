...
use backend\utilities\CoreCommonUtility;
...
<div id="bk-formDefaultLogin" class="loginContainerFullsize">
    ...
    <?php
//    \yii\helpers\VarDumper::dump((!isset(Yii::$app->params['logo']) || !Yii::$app->params['logo']), 3,true);
    if (
        (!empty(AmosAdmin::t('amosadmin', '#login_welcome_message')))
        || (CoreCommonUtility::platformSeenFromHeadquarter() || !$adminModule->hideStandardLoginPageSection)
        ): ?>
