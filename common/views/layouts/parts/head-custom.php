...
?>
<script id="Cookiebot" src="https://consent.cookiebot.com/uc.js" data-cbid="<?= \Yii::$app->params['cookiebotConfigurations']['id']?>" data-blockingmode="auto" type="text/javascript"></script>
