...
class DefaultController extends Controller
{
    ...
    public function actionIndex(array $parms)
    {
        ...
        $lastUpdateDate     = isset($parms["lastUpdateDate"]) ? $parms["lastUpdateDate"] : null;
        $hideFolder         = isset($parms["hideFolder"]) ? $parms["hideFolder"] : null;
        $hideCategory       = isset($parms["hideCategory"]) ? $parms["hideCategory"] : null;
