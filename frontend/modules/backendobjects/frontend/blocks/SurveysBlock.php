 ...
 */
class SurveysBlock extends PhpBlock
{
    ...
    {
        return Yii::t('backendobjects', 'block_module_contenuti_dinamici_surveys');
    }
    ...
    public function admin()
    {
        ...
        */
        $moduleName = "Sondaggi";
        $str_view .= '<img src="/img/preview_cms/sondaggio-preview.png">';/*TODO: img custom*/
    ...
    public function moduleContent()
    {
        ...
        $args = [
            'parms' => [
                "backendModule" => 'open20\\amos\\sondaggi\\AmosSondaggi',
                ...
                "listPage" => $this->getCfgValue('listPage', 'listSondaggiDesign'),
