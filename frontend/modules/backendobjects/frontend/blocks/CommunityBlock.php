 ...
 */
class CommunityBlock extends PhpBlock
{
    ...
    {
        return Yii::t('backendobjects', 'block_module_contenuti_dinamici_community');
    }
    ...
    public function moduleContent()
    {
        ...
        $args = [
            'parms' => [
                "backendModule" => 'open20\\amos\\community\\AmosCommunity',
                ...
                "listPage" => $this->getCfgValue('listPage', 'listCardCommunityDesign'),
