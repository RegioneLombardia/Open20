 ...
 */
class TicketsBlock extends PhpBlock
{
    ...
    {
        return Yii::t('backendobjects', 'block_module_contenuti_dinamici_tickets');
    }
    ...
    public function config()
    {
        return [
            ...
            'cfgs' => [
                ...
                [
                    'var' => 'withoutSearch', 
                    'label' => Yii::t('backendobjects', 'Nascondi ricerca'),
                    'type' => self::TYPE_CHECKBOX, 
                    'initValue' => 0 ,
    ...
    public function admin()
    {
        ...
        $moduleName = "Tickets";
        $str_view .= '<img src="/img/preview_cms/asset-faq-preview.png">';
    ...
    public function moduleContent()
    {
        ...
        $args = [
            'parms' => [
                "backendModule" => 'open2\\amos\\ticket\\AmosTicket',
                ...
                "listPage" => $this->getCfgValue('listPage', 'listCategoryFaq'),
