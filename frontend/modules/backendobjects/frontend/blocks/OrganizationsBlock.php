 ...
 */
class OrganizationsBlock extends PhpBlock
{
    ...
    {
        if(empty(\Yii::$app->getModule('organizzazioni'))){
    ...
    {
        return Yii::t('backendobjects', 'block_module_contenuti_dinamici_organizations');
    }
    ...
    public function admin()
    {
        ...
        */
        $moduleName = "Organizazzioni";
        $str_view .= '<img src="/img/preview_cms/events-preview.png">';/*TODO: img custom*/
    ...
    public function moduleContent()
    {
        ...
        $args = [
            'parms' => [
                "backendModule" => 'open20\\amos\\organizzazioni\\Module',
                ...
                "listPage" => $this->getCfgValue('listPage', 'listCardOrganizzazioniDesign'),
