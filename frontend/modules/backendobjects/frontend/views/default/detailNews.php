                    ...
                    <div class="social-share-box border-top py-4">
                        ...
                        <div class="container-social-share d-flex">
                            <div class="share-wrap-button">
                                <a class="social-network fb" href="http://www.facebook.com/sharer.php?u=<?= \Yii::$app->params['platform']['frontendUrl'] . Url::current() ?>" target="_blank" title="Condividi su Facebook" aria-label="Condividi su Facebook">
                                    <span class="mdi mdi-facebook md-36 m-1" title="Condividi su Facebook"></span>
                                </a>
                            </div>
                            <div class="share-wrap-button">
                                <a class="social-network tw" href="http://twitter.com/share?url=<?= \Yii::$app->params['platform']['frontendUrl'] . Url::current() ?>" target="_blank" title="Condividi su Twitter" aria-label="Condividi su Twitter">
                                    <span class="mdi mdi-twitter md-36 m-1" title="Condividi su Twitter"></span>
                                </a>
                            </div>
                            <div class="share-wrap-button">
                                <a class="social-network lk" href="https://www.linkedin.com/sharing/share-offsite/?url=<?= \Yii::$app->params['platform']['frontendUrl'] . Url::current() ?>" target="_blank" title="Condividi su Linkedin" aria-label="Condividi su Linkedin">
                                    <span class="mdi mdi-linkedin md-36 m-1" title="Condividi su Linkedin"></span>
                                </a>
                            </div>
                            <div class="share-wrap-button">
                                <a class="social-network email" href="mailto:?subject=<?= urlencode($model->title) ?>&body=<?= \Yii::$app->params['platform']['frontendUrl'] . Url::current() ?>" target="_blank" title="Condividi via mail" aria-label="Condividi via mail">
                        ...
                        <div class="uk-container attachments-detail allegati-container col-md-12 col-xs-12">
                            ...
                            <div class="uk-list">
                                ...
                                ?>
                                    ...
                                    <span class="news-allegato-kb small text-muted">(<?= str_replace('.',',',round($documento['size'] / 1024, 2)) ?> KB)</span>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                        </div>
