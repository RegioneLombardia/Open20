...
<?php if (!is_null($dataProvider)) {
    if ($dataProvider->getTotalCount() > 0) {
        ...
        <div class="<?= $cssClass ?>">
            ...
            <div class="documenti-home container py-5 border-top border-light">
                <h3 class="mb-4 h1"><span class="mdi mdi-paperclip"></span> Documenti</h3>
                        ...
                        echo ListView::widget([
                            ...
                            'options' => [
                                'class' => 'document-list row variable-gutters',
                            ]
                        ]);
                        ?>
        ...
        $js = <<<JS
    $('.documenti-home ').attr('style',"display:none !important");
JS;
        $this->registerJs($js);
    }
}
