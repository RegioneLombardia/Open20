            ...
            <div class="list-search-container d-flex flex-wrap">
                ...
                if(!is_null($dataProvider))
                {
                    if ($dataProvider->getTotalCount() > 0) {
                        ...
                        <div class="no-result">
                            <div class="text-message mb-5">
                                <div class="h4">
                                    <?= BaseAmosModule::t('amosapp', 'Nessun risultato trovato.') ?>
                                </div>
                                <div class="lead">
                                    <?= BaseAmosModule::t('amosapp', 'Non è stato trovato nessun elemento con i criteri di ricerca inseriti.') ?>
                                </div>
                            </div>
                        </div>
                    <?php }
