...
$showCategories = strpos(Yii::$app->request->getPathInfo(), 'news');
if($showCategories) {
    ...
    <div class="search-news bg-100 rounded my-5 px-3 pt-5 pb-3">
        <div class="row">
            ...
            <div class="col-lg-2 form-group text-md-right">
                <?= Html::a('<span class="mdi mdi-close"></span> <span class="d-lg-none">Cancella filtri</span>', $currentUrl, ['class' => 'btn btn-sm px-2 btn-outline-tertiary', 'title' => 'Cancella filtri']) ?>
