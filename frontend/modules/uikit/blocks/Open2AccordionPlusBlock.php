...
final class Open2AccordionPlusBlock extends BaseUikitBlock
{
    /**
     * @inheritdoc
     */
    protected $component = "open2accordionplus";
    ...
    public function admin()
    {
        if(count($this->getVarValue('items', []))) {
            ...
            return '<div><span class="block__empty-text">' . Module::t('Accordion') . '</span></div>';
        }
    }
