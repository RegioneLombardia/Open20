 ...
 */
class m200408_100313_add_locations3 extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insert('event_location_entrances',['event_location_id' => 1, 'name' => "Palazzo Lombardia - Spazio Mostre - Piazza Città di Lombardia - ingresso N3", ]);
