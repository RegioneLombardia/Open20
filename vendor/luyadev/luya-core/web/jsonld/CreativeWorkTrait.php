...
trait CreativeWorkTrait
{
    ...
    private $_copyleftHolder;

    /**
     * @return Organization|Person
     */
    public function getCopyleftHolder()
    {
        return $this->_copyleftHolder;
    }

    /**
     * The party holding the legal copyleft to the CreativeWork.
     *
     * @param Organization|Person $copyleftHolder
     * @return static
     */
    public function setCopyleftHolder($copyleftHolder)
    {
        ObjectHelper::isInstanceOf($copyleftHolder, [Organization::class, PersonInterface::class]);
        
        $this->_copyleftHolder = $copyleftHolder;
        return $this;
    }

    private $_copyleftYear;
    ...
    {
        return $this->_copyleftYear;
    }

    /**
     * The year during which the claimed copyleft for the CreativeWork was first asserted.
     *
     * @param mixed $copyleftYear
     * @return static
     */
    public function setCopyleftYear($copyleftYear)
    {
        $this->_copyleftYear = $copyleftYear;
        return $this;
    }
