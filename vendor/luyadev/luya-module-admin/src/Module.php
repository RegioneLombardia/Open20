...
final class Module extends \luya\admin\base\Module implements CoreModuleInterface
{
     ...
     * Currently supported: en, de, ru, es, fr, ua, it, el, vi, pl, pt, tr, fa, cn, nl, th, hu, id
     */
    ...
    public function getJsTranslationMessages()
    {
        return [
            ...
            'js_jsonobject_newkey', 'menu_dashboard', 'file_caption_success', 'ngrest_delete_all_button_confirm_message', 'ngrest_delete_all_button_label', 'js_dir_alt_name_hint', 'js_dir_alt_name',
            // cropping
