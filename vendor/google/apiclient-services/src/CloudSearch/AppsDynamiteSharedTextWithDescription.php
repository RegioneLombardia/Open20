...
class AppsDynamiteSharedTextWithDescription extends \Google\Collection
{
  ...
  {
    $this->textSegmentsWithDescription = $textSegmentsWithDescription;
  }
  /**
  ...
  {
    return $this->textSegmentsWithDescription;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(AppsDynamiteSharedTextWithDescription::class, 'Google_Service_CloudSearch_AppsDynamiteSharedTextWithDescription');
