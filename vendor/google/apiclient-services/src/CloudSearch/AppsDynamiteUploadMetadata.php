...
class AppsDynamiteUploadMetadata extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AppsDynamiteUploadMetadata::class, 'Google_Service_CloudSearch_AppsDynamiteUploadMetadata');
