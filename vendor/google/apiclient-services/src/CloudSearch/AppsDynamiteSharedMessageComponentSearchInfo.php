...
class AppsDynamiteSharedMessageComponentSearchInfo extends \Google\Model
{
  ...
  {
    return $this->titleTextWithDescription;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(AppsDynamiteSharedMessageComponentSearchInfo::class, 'Google_Service_CloudSearch_AppsDynamiteSharedMessageComponentSearchInfo');
