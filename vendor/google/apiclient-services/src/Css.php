...
class Css extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->rootUrl = $rootUrl ?: 'https://css.googleapis.com/';
    $this->rootUrlTemplate = $rootUrl ?: 'https://css.UNIVERSE_DOMAIN/';
    $this->servicePath = '';
    $this->batchPath = 'batch';
    $this->version = 'v1';
    $this->serviceName = 'css';

    $this->accounts = new Css\Resource\Accounts(
        $this,
        $this->serviceName,
        'accounts',
        [
    ...
    $this->accounts_cssProductInputs = new Css\Resource\AccountsCssProductInputs(
        $this,
        $this->serviceName,
        'cssProductInputs',
        [
    ...
    $this->accounts_cssProducts = new Css\Resource\AccountsCssProducts(
        $this,
        $this->serviceName,
        'cssProducts',
        [
    ...
    $this->accounts_labels = new Css\Resource\AccountsLabels(
        $this,
        $this->serviceName,
        'labels',
        [
...
class_alias(Css::class, 'Google_Service_Css');
