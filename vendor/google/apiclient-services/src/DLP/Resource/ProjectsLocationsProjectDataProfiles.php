 ...
 *  </code>
 */
class ProjectsLocationsProjectDataProfiles extends \Google\Service\Resource
{
  /**
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsProjectDataProfiles($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsProjectDataProfiles::class, 'Google_Service_DLP_Resource_ProjectsLocationsProjectDataProfiles');
