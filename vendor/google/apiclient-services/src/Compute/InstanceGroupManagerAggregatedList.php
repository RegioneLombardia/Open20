...
class InstanceGroupManagerAggregatedList extends \Google\Collection
{
...
class_alias(InstanceGroupManagerAggregatedList::class, 'Google_Service_Compute_InstanceGroupManagerAggregatedList');
