...
class Commitment extends \Google\Collection
{
   ...
   */
  public $kind;
  protected $licenseResourceType = ProscriptionResourceCommitment::class;
   ...
   */
  public function setProscriptionResource(ProscriptionResourceCommitment $licenseResource)
  {
