...
class NetworkEdgeSecurityServiceAggregatedList extends \Google\Collection
{
...
class_alias(NetworkEdgeSecurityServiceAggregatedList::class, 'Google_Service_Compute_NetworkEdgeSecurityServiceAggregatedList');
