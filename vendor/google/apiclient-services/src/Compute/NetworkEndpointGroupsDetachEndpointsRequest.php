...
class NetworkEndpointGroupsDetachEndpointsRequest extends \Google\Collection
{
...
class_alias(NetworkEndpointGroupsDetachEndpointsRequest::class, 'Google_Service_Compute_NetworkEndpointGroupsDetachEndpointsRequest');
