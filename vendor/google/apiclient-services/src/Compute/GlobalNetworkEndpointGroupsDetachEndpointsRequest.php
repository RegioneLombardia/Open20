...
class GlobalNetworkEndpointGroupsDetachEndpointsRequest extends \Google\Collection
{
...
class_alias(GlobalNetworkEndpointGroupsDetachEndpointsRequest::class, 'Google_Service_Compute_GlobalNetworkEndpointGroupsDetachEndpointsRequest');
