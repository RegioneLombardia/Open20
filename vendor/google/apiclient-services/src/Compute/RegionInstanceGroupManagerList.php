...
class RegionInstanceGroupManagerList extends \Google\Collection
{
...
class_alias(RegionInstanceGroupManagerList::class, 'Google_Service_Compute_RegionInstanceGroupManagerList');
