...
class InstanceGroupsSetNamedPortsRequest extends \Google\Collection
{
...
class_alias(InstanceGroupsSetNamedPortsRequest::class, 'Google_Service_Compute_InstanceGroupsSetNamedPortsRequest');
