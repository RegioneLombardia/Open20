 ...
 *  </code>
 */
class Uiv1beta3ProjectsLocationsOperations extends \Google\Service\Resource
{
  /**
   ...
   * id. (operations.listUiv1beta3ProjectsLocationsOperations)
   *
   ...
   */
  public function listUiv1beta3ProjectsLocationsOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(Uiv1beta3ProjectsLocationsOperations::class, 'Google_Service_Document_Resource_Uiv1beta3ProjectsLocationsOperations');
