 ...
 *   $savedQueries = $loggingService->organizations_locations_savedQueries;
 *  </code>
 */
class OrganizationsLocationsSavedQueries extends \Google\Service\Resource
{
  /**
   ...
   * (savedQueries.listOrganizationsLocationsSavedQueries)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listOrganizationsLocationsSavedQueries($parent, $optParams = [])
  {
...
class_alias(OrganizationsLocationsSavedQueries::class, 'Google_Service_Logging_Resource_OrganizationsLocationsSavedQueries');
