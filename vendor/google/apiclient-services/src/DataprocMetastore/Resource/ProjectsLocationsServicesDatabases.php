...
class ProjectsLocationsServicesDatabases extends \Google\Service\Resource
{
   ...
   * resource exists and does not have a policy set. (databases.getIamPolicy)
   *
...
class_alias(ProjectsLocationsServicesDatabases::class, 'Google_Service_DataprocMetastore_Resource_ProjectsLocationsServicesDatabases');
