...
class ProjectsLocationsOperations extends \Google\Service\Resource
{
  ...
  public function delete($name, $optParams = [])
  {
    ...
    return $this->call('delete', [$params], MetastoreEmpty::class);
  }
  /**
...
class_alias(ProjectsLocationsOperations::class, 'Google_Service_DataprocMetastore_Resource_ProjectsLocationsOperations');
