...
class ChromeOsDevice extends \Google\Collection
{
   ...
   * @param string
   */
  public function setDeviceProscriptionType($deviceProscriptionType)
  {
    $this->deviceProscriptionType = $deviceProscriptionType;
  }
  /**
   * @return string
   */
  public function getDeviceProscriptionType()
  {
    return $this->deviceProscriptionType;
  }
  /**
