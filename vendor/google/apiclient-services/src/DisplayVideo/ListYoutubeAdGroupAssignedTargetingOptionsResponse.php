...
class ListYoutubeAdGroupAssignedTargetingOptionsResponse extends \Google\Collection
{
...
class_alias(ListYoutubeAdGroupAssignedTargetingOptionsResponse::class, 'Google_Service_DisplayVideo_ListYoutubeAdGroupAssignedTargetingOptionsResponse');
