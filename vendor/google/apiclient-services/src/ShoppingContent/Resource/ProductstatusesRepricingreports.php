...
class ProductstatusesRepricingreports extends \Google\Service\Resource
{
  ...
  public function listProductstatusesRepricingreports($merchantId, $productId, $optParams = [])
  {
    ...
    return $this->call('list', [$params], ListRepricingProductReportsResponse::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(ProductstatusesRepricingreports::class, 'Google_Service_ShoppingContent_Resource_ProductstatusesRepricingreports');
