...
class ListBusinessMessagesLinksResponse extends \Google\Collection
{
  ...
  {
    $this->businessMessagesLinks = $businessMessagesLinks;
  }
  /**
  ...
  {
    return $this->businessMessagesLinks;
  }
  /**
   * @param string
   */
...
class_alias(ListBusinessMessagesLinksResponse::class, 'Google_Service_ShoppingContent_ListBusinessMessagesLinksResponse');
