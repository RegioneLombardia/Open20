...
class_alias(GoogleCloudDocumentaiV1DocumentPageDetectedBarcode::class, 'Google_Service_Contentwarehouse_GoogleCloudDocumentaiV1DocumentPageDetectedBarcode');
