...
class_alias(GoogleCloudContactcenterinsightsV1alpha1GetGeneratorSuggestionResponse::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1GetGeneratorSuggestionResponse');
