...
class ProjectsGithubEnterpriseConfigs extends \Google\Service\Resource
{
   ...
   */
  public function listProjectsGithubEnterpriseConfigs($parent, $optParams = [])
  {
...
class_alias(ProjectsGithubEnterpriseConfigs::class, 'Google_Service_CloudBuild_Resource_ProjectsGithubEnterpriseConfigs');
