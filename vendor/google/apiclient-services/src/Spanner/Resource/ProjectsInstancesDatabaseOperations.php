...
class ProjectsInstancesDatabaseOperations extends \Google\Service\Resource
{
   ...
   * admin.database.v1.RestoreDatabaseMetadata) AND` \
   ...
   * operation's metadata type is RestoreDatabaseMetadata. * The database is
  ...
  public function listProjectsInstancesDatabaseOperations($parent, $optParams = [])
  {
    ...
    return $this->call('list', [$params], ListDatabaseOperationsResponse::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(ProjectsInstancesDatabaseOperations::class, 'Google_Service_Spanner_Resource_ProjectsInstancesDatabaseOperations');
