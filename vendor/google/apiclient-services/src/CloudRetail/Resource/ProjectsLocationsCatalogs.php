...
class ProjectsLocationsCatalogs extends \Google\Service\Resource
{
   ...
   * option requires additional allowlisting. Before using cloud-retail, contact
   ...
   * types, e.g. DESKTOP, MOBILE. If it is empty, the suggestions are across all
   * device types. Supported formats: * UNKNOWN_DEVICE_TYPE * DESKTOP * MOBILE * A
