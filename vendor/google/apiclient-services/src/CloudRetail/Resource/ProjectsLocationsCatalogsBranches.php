 ...
 *   $branches = $retailService->branches;
 *  </code>
 */
...
class_alias(ProjectsLocationsCatalogsBranches::class, 'Google_Service_CloudRetail_Resource_ProjectsLocationsCatalogsBranches');
