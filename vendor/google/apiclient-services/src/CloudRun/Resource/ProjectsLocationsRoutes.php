 ...
 *  </code>
 */
class ProjectsLocationsRoutes extends \Google\Service\Resource
{
  /**
   ...
   */
  public function listProjectsLocationsRoutes($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsRoutes::class, 'Google_Service_CloudRun_Resource_ProjectsLocationsRoutes');
