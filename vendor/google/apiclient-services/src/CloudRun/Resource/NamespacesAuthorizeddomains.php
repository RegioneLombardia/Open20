 ...
 *  </code>
 */
class NamespacesAuthorizeddomains extends \Google\Service\Resource
{
  /**
   ...
   */
  public function listNamespacesAuthorizeddomains($parent, $optParams = [])
  {
...
class_alias(NamespacesAuthorizeddomains::class, 'Google_Service_CloudRun_Resource_NamespacesAuthorizeddomains');
