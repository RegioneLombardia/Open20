...
class_alias(GoogleCloudDiscoveryengineV1betaFetchDomainVerificationStatusResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaFetchDomainVerificationStatusResponse');
