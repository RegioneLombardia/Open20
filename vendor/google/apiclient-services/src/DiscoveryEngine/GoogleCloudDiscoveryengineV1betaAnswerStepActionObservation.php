...
class_alias(GoogleCloudDiscoveryengineV1betaAnswerStepActionObservation::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaAnswerStepActionObservation');
