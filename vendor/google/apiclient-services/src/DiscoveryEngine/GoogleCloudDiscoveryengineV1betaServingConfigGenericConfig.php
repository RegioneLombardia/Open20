...
class_alias(GoogleCloudDiscoveryengineV1betaServingConfigGenericConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaServingConfigGenericConfig');
