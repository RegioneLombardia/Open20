...
class GoogleCloudDiscoveryengineV1OcrParsingConfig extends \Google\Collection
{
...
class_alias(GoogleCloudDiscoveryengineV1OcrParsingConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1OcrParsingConfig');
