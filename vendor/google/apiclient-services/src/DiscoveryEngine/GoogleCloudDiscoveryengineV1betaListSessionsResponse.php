...
class_alias(GoogleCloudDiscoveryengineV1betaListSessionsResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaListSessionsResponse');
