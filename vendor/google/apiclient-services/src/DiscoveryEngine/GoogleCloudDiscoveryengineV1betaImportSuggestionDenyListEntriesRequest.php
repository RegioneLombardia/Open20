...
class_alias(GoogleCloudDiscoveryengineV1betaImportSuggestionDenyListEntriesRequest::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaImportSuggestionDenyListEntriesRequest');
