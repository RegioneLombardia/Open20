...
class GoogleCloudDiscoveryengineV1alphaOcrParsingConfig extends \Google\Collection
{
...
class_alias(GoogleCloudDiscoveryengineV1alphaOcrParsingConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaOcrParsingConfig');
