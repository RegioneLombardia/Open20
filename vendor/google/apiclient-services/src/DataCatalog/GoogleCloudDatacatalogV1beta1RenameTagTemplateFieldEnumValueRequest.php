...
class_alias(GoogleCloudDatacatalogV1beta1RenameTagTemplateFieldEnumValueRequest::class, 'Google_Service_DataCatalog_GoogleCloudDatacatalogV1beta1RenameTagTemplateFieldEnumValueRequest');
