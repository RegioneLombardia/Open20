...
class Eventticketclass extends \Google\Service\Resource
{
  ...
  public function addmessage($resourceId, AddMessageRequest $postBody, $optParams = [])
  {
    ...
    return $this->call('addmessage', [$params], EventTicketClassAddMessageResponse::class);
  }
  /**
  ...
  public function insert(EventTicketClassModel $postBody, $optParams = [])
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', [$params], EventTicketClassModel::class);
  }
  /**
  ...
  public function listEventticketclass($optParams = [])
  {
    $params = [];
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], EventTicketClassListResponse::class);
  }
  /**
  ...
  public function patch($resourceId, EventTicketClassModel $postBody, $optParams = [])
  {
    $params = ['resourceId' => $resourceId, 'postBody' => $postBody];
    $params = array_merge($params, $optParams);
    return $this->call('patch', [$params], EventTicketClassModel::class);
  }
  /**
  ...
  public function update($resourceId, EventTicketClassModel $postBody, $optParams = [])
  {
    $params = ['resourceId' => $resourceId, 'postBody' => $postBody];
    $params = array_merge($params, $optParams);
    return $this->call('update', [$params], EventTicketClassModel::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(Eventticketclass::class, 'Google_Service_Walletobjects_Resource_Eventticketclass');
