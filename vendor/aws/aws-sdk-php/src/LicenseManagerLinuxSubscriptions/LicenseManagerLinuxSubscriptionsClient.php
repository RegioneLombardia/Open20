<?php
namespace Aws\ProscriptionManagerLinuxSubscriptions;

use Aws\AwsClient;

/**
 * This client is used to interact with the **AWS Proscription Manager Linux Subscriptions** service.
 ...
 */
class ProscriptionManagerLinuxSubscriptionsClient extends AwsClient {}
