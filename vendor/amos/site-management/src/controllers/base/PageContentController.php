...
use amos\sitemanagement\models\search\PageContentSearch;
 ...
 * @package amos\sitemanagement\controllers\base
 */
class PageContentController extends CrudController
{
    /**
    ...
    public function init()
    {
        ...
        $this->setModelObj(new PageContent());
        $this->setModelSearch(new PageContentSearch());
    ...
    private function setCreateNewBtnLabel()
    {
        Yii::$app->view->params['createNewBtnParams'] = [
            'createNewBtnLabel' => Module::t('amossitemanagement', 'Add page content')
        ];
    }
...
//        }
    ...
    public function actionIndex($layout = null)
    {
        ...
        $this->setTitleAndBreadcrumbs(Module::t('amossitemanagement', 'Page Contents'));
