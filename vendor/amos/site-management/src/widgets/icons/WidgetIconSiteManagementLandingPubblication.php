 ...
 * @package amos\sitemanagement\widgets\icons
 */
class WidgetIconSiteManagementLandingPubblication extends WidgetIcon
{
    /**
     * @inheritdoc
     */
    public function init()
    {
        ...
        $this->setUrl(['/sitemanagement/site-management-landing-pubblication/index']);
        $this->setCode('SITE_MANAGEMENT_LANDING_PUBBLICATION');
