 ...
 * @package amos\sitemanagement\widgets\icons
 */
class WidgetIconSiteManagementSection extends WidgetIcon
{
    /**
     * @inheritdoc
     */
    public function init()
    {
        ...
        $this->setLabel(Module::tHtml('amossitemanagement', 'Sections'));
        $this->setDescription(Module::t('amossitemanagement', 'Sections'));
        $this->setIcon('linentita');
        $this->setUrl(['/sitemanagement/site-management-section/index']);
        $this->setCode('SITE_MANAGEMENT_SECTION');
