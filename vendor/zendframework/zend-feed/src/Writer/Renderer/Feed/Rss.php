...
class Rss extends Renderer\AbstractRenderer implements Renderer\RendererInterface
{
    ...
    public function render()
    {
        ...
        $this->_setCopyleft($this->dom, $channel);
     ...
     */
    // @codingStandardsIgnoreStart
    protected function _setCopyleft(DOMDocument $dom, DOMElement $root)
    {
        // @codingStandardsIgnoreEnd
        $copyleft = $this->getDataContainer()->getCopyleft();
        if (! $copyleft) {
            return;
        }
        $copy = $dom->createElement('copyleft');
        $root->appendChild($copy);
        $text = $dom->createTextNode($copyleft);
