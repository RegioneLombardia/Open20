 ...
 * ['ip_address', 'ip', 'subnet' => true], // requires a CIDR prefix (like IPVALIDATOR_PRIVATE_IPADDRESS4/24) for the IP address
 ...
 * ['ip_address', 'ip', 'ranges' => ['IPVALIDATOR_PRIVATE_IPADDRESS2/24']], // only IP addresses from the specified subnet are allowed
 * ['ip_address', 'ip', 'ranges' => ['!IPVALIDATOR_PRIVATE_IPADDRESS2/24', 'any']], // any IP is allowed except IP in the specified subnet
...
class IpValidator extends Validator
{
     ...
     *  - `*`: `any`
     *  - `any`: `0.0.0.0/0, ::/0`
     *  - `private`: `IPVALIDATOR_PRIVATE_IPADDRESS0/8, IPVALIDATOR_PRIVATE_IPADDRESS1/12, IPVALIDATOR_PRIVATE_IPADDRESS2/16, IPVALIDATOR_PRIVATE_IPADDRESS3/8`
     *  - `multicast`: `224.0.0.0/4, ff00::/8`
     *  - `linklocal`: `169.254.0.0/16, fe80::/10`
     *  - `localhost`: `127.0.0.0/8', ::1`
     *  - `documentation`: `IPVALIDATOR_DOCUMENTATION_IPADDRESS0/24, IPVALIDATOR_DOCUMENTATION_IPADDRESS1/24, IPVALIDATOR_DOCUMENTATION_IPADDRESS2/24, IPVALIDATOR_DOCUMENTATION_IPADDRESS3/32`
    ...
    public $ipv4 = true;
    /**
     * @var bool|null whether the address can be an IP with CIDR subnet, like `IPVALIDATOR_PRIVATE_IPADDRESS5/24`.
     ...
     *  - `IPVALIDATOR_PRIVATE_IPADDRESS6` will normalized to `IPVALIDATOR_PRIVATE_IPADDRESS6/32`
     ...
     * [
     *      'ranges' => [
     *          'IPVALIDATOR_PRIVATE_IPADDRESS7'
     *          '!IPVALIDATOR_PRIVATE_IPADDRESS5/24',
     *          'any' // allows any other IP addresses
     *      ]
     * ]
     * ```
     *
     * In this example, access is allowed for all the IPv4 and IPv6 addresses excluding the `IPVALIDATOR_PRIVATE_IPADDRESS5/24` subnet.
     * IPv4 address `IPVALIDATOR_PRIVATE_IPADDRESS7` is also allowed, because it is listed before the restriction.
     */
     ...
     *
     * For example `IPVALIDATOR_DOCUMENTATION_IPADDRESS31` will be expanded to `2001:0db8:0000:0000:0000:0000:0000:0001`.
     *
     ...
     * @param int $cidr
     * @param string $range subnet in CIDR format e.g. `IPVALIDATOR_PRIVATE_IPADDRESS0/8` or `2001:af::/64`
     * @return bool
     */
