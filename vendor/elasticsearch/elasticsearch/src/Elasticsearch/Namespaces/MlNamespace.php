...
class MlNamespace extends AbstractNamespace
{
    ...
    /**
     * $params['job_id']        = (string) The name of the job to close (Required)
    ...
    /**
     * $params['calendar_id'] = (string) The ID of the calendar to delete (Required)
     *
     * @param array $params Associative array of parameters
     * @return array
     */
    ...
    /**
     * $params['calendar_id'] = (string) The ID of the calendar to modify (Required)
     * $params['event_id']    = (string) The ID of the event to remove from the calendar (Required)
     *
     * @param array $params Associative array of parameters
     * @return array
     */
    ...
    /**
     * $params['calendar_id'] = (string) The ID of the calendar to modify (Required)
     * $params['job_id']      = (string) The ID of the job to remove from the calendar (Required)
     *
     * @param array $params Associative array of parameters
     * @return array
     */
    ...
    /**
     * $params['datafeed_id'] = (string) The ID of the datafeed to delete (Required)
    ...
    /**
     * $params['filter_id'] = (string) The ID of the filter to delete (Required)
     *
     * @param array $params Associative array of parameters
     * @return array
     */
    ...
    /**
     * $params['job_id']              = (string) The ID of the job to delete (Required)
     ...
     * $params['snapshot_id'] = (string) The ID of the snapshot to delete (Required)
     *
     * @param array $params Associative array of parameters
     * @return array
     */
    ...
    /**
     * $params['job_id']       = (string) The name of the job to flush (Required)
    ...
    /**
     * $params['job_id']     = (string) The ID of the job to forecast for (Required)
    ...
    /**
     * $params['calendar_id'] = (string) The ID of the calendar containing the events (Required)
    ...
    /**
     * $params['job_id']          = (string) The job IDs for which to calculate overall bucket results (Required)
    ...
    /**
     * $params['job_id']          = (string) The ID of the job to open (Required)
     * $params['ignore_downtime'] = (boolean) Controls if gaps in data are treated as anomalous or as a maintenance window after a job re-start
     * $params['timeout']         = (time) Controls the time to wait until a job has opened. Default to 30 minutes
     *
     * @param array $params Associative array of parameters
     * @return array
     */
    ...
    /**
     * $params['job_id']      = (string) The name of the job receiving the data (Required)
    ...
    /**
     * $params['datafeed_id'] = (string) The ID of the datafeed to preview (Required)
     *
     * @param array $params Associative array of parameters
     * @return array
     */
    ...
    /**
     * $params['calendar_id'] = (string) The ID of the calendar to create (Required)
    ...
    /**
     * $params['calendar_id'] = (string) The ID of the calendar to modify (Required)
     * $params['job_id']      = (string) The ID of the job to add to the calendar (Required)
     *
     * @param array $params Associative array of parameters
     * @return array
     */
    ...
    /**
     * $params['datafeed_id'] = (string) The ID of the datafeed to create (Required)
    ...
    /**
     * $params['filter_id'] = (string) The ID of the filter to create (Required)
    ...
    /**
     * $params['job_id'] = (string) The ID of the job to create (Required)
    ...
    /**
     * $params['job_id']                     = (string) The ID of the job to fetch (Required)
     * $params['snapshot_id']                = (string) The ID of the snapshot to revert to (Required)
    ...
    /**
     * $params['datafeed_id'] = (string) The ID of the datafeed to start (Required)
    ...
    /**
     * $params['datafeed_id']        = (string) The ID of the datafeed to stop (Required)
     * $params['allow_no_datafeeds'] = (boolean) Whether to ignore if a wildcard expression matches no datafeeds. (This includes `_all` string or when no datafeeds have been specified)
    ...
    /**
     * $params['datafeed_id'] = (string) The ID of the datafeed to update (Required)
    ...
    /**
     * $params['filter_id'] = (string) The ID of the filter to update (Required)
    ...
    /**
     * $params['job_id']      = (string) The ID of the job to fetch (Required)
     * $params['snapshot_id'] = (string) The ID of the snapshot to update (Required)
