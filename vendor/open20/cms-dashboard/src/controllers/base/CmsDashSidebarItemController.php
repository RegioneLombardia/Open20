...
namespace open20\cms\dashboard\controllers\base;

use open20\cms\dashboard\models\search\CmsDashSidebarItemSearch;
 ...
 * CmsDashSidebarItemController implements the CRUD actions for CmsDashSidebarItem model.
 *
 * @property \open20\cms\dashboard\models\CmsDashSidebarItem $model
 * @property \ $modelSearch
 *
 * @package controllers\base
 */
class CmsDashSidebarItemController extends CrudController
{
    ...
    {
        $this->setModelObj(new CmsDashSidebarItem());
        $this->setModelSearch(new CmsDashSidebarItemSearch());
    ...
    /**
     * Lists all CmsDashSidebarItem models.
     * @return mixed
     */
    ...
    /**
     * Displays a single CmsDashSidebarItem model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CmsDashSidebarItem model.
    ...
    public function actionCreate()
    {
        ...
        $this->model = new CmsDashSidebarItem();
        ...
        return $this->render('create', [
            ...
            'dataField' => NULL,
            'dataEntity' => NULL,
            'roles' => Utility::getAllRoles()
        ]);
    }

    /**
     * Creates a new CmsDashSidebarItem model by ajax request.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
...
//Yii::$app->getSession()->addFlash('danger', BaseAmosModule::t('amoscore', 'Item not created, check data'));
    ...
    /**
     * Updates an existing CmsDashSidebarItem model.
    ...
    /**
     * Deletes an existing CmsDashSidebarItem model.
    ...
    public function actionDelete($id)
    {
        ...
        if ($this->model) {
            $this->model->delete();
            $models = CmsDashSidebarItem::find()
                ->where(['>', 'position', $this->model->position])
