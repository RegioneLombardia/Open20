...
{
    // WORKFLOW NAME
    const WORKFLOW = 'CommentWorkflow';

    // WORKFLOW STATUSES
    const STATUS_TOVALIDATE = 'CommentWorkflow/TOVALIDATE';
    const STATUS_PUBLISHED = 'CommentWorkflow/PUBLISHED';
    const STATUS_REJECTED = 'CommentWorkflow/REJECTED';
