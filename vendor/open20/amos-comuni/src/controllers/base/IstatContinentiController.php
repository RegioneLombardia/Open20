...
use open20\amos\comuni\models\search\IstatContinentiSearch;
...
/**
 * IstatContinentiController implements the CRUD actions for IstatContinenti model.
 */
class IstatContinentiController extends CrudController
{
    /**
     * @var string $layout
     */
    ...
    {
        $this->setModelObj(new IstatContinenti());
        $this->setModelSearch(new IstatContinentiSearch());
    ...
    /**
     * Lists all IstatContinenti models.
     * @return mixed
     */
    ...
    /**
     * Displays a single IstatContinenti model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Finds the IstatContinenti model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return IstatContinenti the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = IstatContinenti::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    /**
     * Creates a new IstatContinenti model.
    ...
    /**
     * Updates an existing IstatContinenti model.
    ...
    /**
     * Deletes an existing IstatContinenti model.
