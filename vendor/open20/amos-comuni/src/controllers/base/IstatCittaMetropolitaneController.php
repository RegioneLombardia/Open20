...
use open20\amos\comuni\models\search\IstatCittaMetropolitaneSearch;
...
/**
 * IstatCittaMetropolitaneController implements the CRUD actions for IstatCittaMetropolitane model.
 */
class IstatCittaMetropolitaneController extends CrudController
{
    /**
     * @var string $layout
     */
    ...
    {
        $this->setModelObj(new IstatCittaMetropolitane());
        $this->setModelSearch(new IstatCittaMetropolitaneSearch());
    ...
    /**
     * Lists all IstatCittaMetropolitane models.
     * @return mixed
     */
    ...
    /**
     * Displays a single IstatCittaMetropolitane model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Finds the IstatCittaMetropolitane model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return IstatCittaMetropolitane the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = IstatCittaMetropolitane::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    /**
     * Creates a new IstatCittaMetropolitane model.
    ...
    public function actionCreate()
    {
        ...
        $model = new IstatCittaMetropolitane;
    ...
    /**
     * Updates an existing IstatCittaMetropolitane model.
    ...
    /**
     * Deletes an existing IstatCittaMetropolitane model.
