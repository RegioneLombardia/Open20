...
use open20\amos\comuni\models\search\IstatRegioniSearch;
...
/**
 * IstatRegioniController implements the CRUD actions for IstatRegioni model.
 */
class IstatRegioniController extends CrudController
{
    /**
     * @var string $layout
     */
    ...
    {
        $this->setModelObj(new IstatRegioni());
        $this->setModelSearch(new IstatRegioniSearch());
    ...
    /**
     * Displays a single IstatRegioni model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Finds the IstatRegioni model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return IstatRegioni the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = IstatRegioni::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    /**
     * Creates a new IstatRegioni model.
    ...
    /**
     * Updates an existing IstatRegioni model.
    ...
    /**
     * Deletes an existing IstatRegioni model.
