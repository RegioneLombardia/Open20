...
/**
 * This is the model class for table "collaboration_ipr_status_mm".
 *
 ...
 */
class CollaborationIprStatusMm extends \open20\amos\collaborations\models\base\CollaborationIprStatusMm
{
...
//inserire il campo o i campi rappresentativi del modulo
    ...
    public static function getEditFields()
    {
        ...
        return [
            ...
            [
                'slug' => 'collaboration_ipr_status_id',
                'label' => $labels['collaboration_ipr_status_id'],
                'type' => 'integer'
            ],
        ];
    }
