...
/**
 * This is the base-model class for table "collaboration_market_keywords_mm".
 *
 * @property integer $id
 * @property integer $collaboration_proposals_id
 * @property integer $collaboration_market_keywords_id
 ...
 */
class  CollaborationMarketKeywordsMm extends \yii\db\ActiveRecord
{
    ...
    {
        return 'collaboration_market_keywords_mm';
    }
    ...
    {
        return [
            [['collaboration_proposals_id', 'collaboration_market_keywords_id'], 'required'],
            [['collaboration_proposals_id', 'collaboration_market_keywords_id', 'created_by', 'updated_by', 'deleted_by'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'collaboration_market_keywords_id' => Yii::t('amoscollaborations', 'Collaboration Market Keywords ID'),
