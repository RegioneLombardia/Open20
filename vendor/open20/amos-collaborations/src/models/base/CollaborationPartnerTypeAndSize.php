...
/**
 * This is the base-model class for table "collaboration_partner_type_and_size".
 *
 * @property integer $id
 ...
 */
class  CollaborationPartnerTypeAndSize extends \yii\db\ActiveRecord
{
    ...
    {
        return 'collaboration_partner_type_and_size';
    }
