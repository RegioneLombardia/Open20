...
/**
 * This is the base-model class for table "collaboration_ipr_status".
 *
 * @property integer $id
 ...
 */
class  CollaborationIprStatus extends \yii\db\ActiveRecord
{
    ...
    {
        return 'collaboration_ipr_status';
    }
    ...
    {
        return $this->hasMany(\open20\amos\collaborations\models\CollaborationIprStatusMm::className(), ['collaboration_ipr_status_id' => 'id']);
    }
}
