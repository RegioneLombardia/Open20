...
/**
 * This is the base-model class for table "collaboration_type".
 *
 * @property integer $id
 ...
 */
class  CollaborationType extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\open20\amos\collaborations\models\CollaborationProposals::className(), ['collaboration_type_id' => 'id']);
    }
}
