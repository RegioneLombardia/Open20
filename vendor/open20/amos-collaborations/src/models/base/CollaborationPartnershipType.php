...
/**
 * This is the base-model class for table "collaboration_partnership_type".
 *
 * @property integer $id
 ...
 */
class  CollaborationPartnershipType extends \yii\db\ActiveRecord
{
    ...
    {
        return 'collaboration_partnership_type';
    }
