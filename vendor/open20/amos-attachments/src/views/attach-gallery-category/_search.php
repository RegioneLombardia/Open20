...
?>
<div class="attach-gallery-category-search element-to-toggle" data-toggle-element="form-search">
...
<!-- default_order -->
<div class="col-md-4"> <?= 
$form->field($model, 'default_order')->textInput(['placeholder' => 'ricerca per default order' ]) ?>
