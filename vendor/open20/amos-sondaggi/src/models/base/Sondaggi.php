...
abstract class Sondaggi extends ContentModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['publish_date', 'compare', 'compareValue' => date('Y-m-d'), 'operator' => '>=', 'on' => self::SCENARIO_CREATE, 'message' => Yii::t('amossondaggi', '{attribute} must be greater than or equal to "{dateFormatter}".', ['dateFormatter' => Yii::$app->formatter->asDate(date('Y-m-d'))])],
