...
//        }
                                  ...
                                  $url = null, $language = null, $field_extra = null)
    {
        ...
        if (Yii::$app->request->isPost) {
            ...
            if ($newModel->load($data) && $newModel->validate()) {
                if ($completato) {
                    if (isset($session['answer_data'])) {
                        unset($session['answer_data']);
                    }
                    if (!empty($url)) {
                        return $this->redirect([$url]);
                    } else {
                                  ...
                                  $url = null, $read = false, $language = null, $field_extra = null)
    {
        ...
        if(!Yii::$app->user->can('ADMIN')){
            ...
            if(AmosSondaggi::instance()->enableSingleCompilation && !empty($this->model->sondaggiRisposteSessionisByEntity)){
