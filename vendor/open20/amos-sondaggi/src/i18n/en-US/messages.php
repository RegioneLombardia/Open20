 ...
 *
 *
 * @package    open20\amos\sondaggi\i18n\en-US
...
return [
    ...
    '#publish_poll' => 'Activate poll',
    '#publish_poll_dialog' => 'Are you sure you want to activate this poll?<br>WARNING: No invitations list is active',
...
Grazie per aver scelto i nostri servizi',
    ...
    '#invito_organization_message' => '{ente} sei stato invitato alla compilazione del sondaggio {titolo} sulla piattaforma Fabbisogni Online.<br>
<br>
...
Grazie per aver scelto i nostri servizi',
    ...
    '#compilazioni_disponibili_hint' => 'The number of compilations is applied for each logged-in user. If set to 0, survey compilation will be unlimited',

    '#all_users_invited_to_poll' => 'All users invited to complete the survey',
    '#users_poll_compiled' => 'Only users who have completed the survey',
    '#users_invited_to_poll_not_compiled' => 'Only users who have been invited but have not yet completed the survey',
    '#all_community_users_invited_to_poll' => 'All community participants invited to complete the survey',
    '#community_users_poll_compiled' => 'Only community participants who filled out the survey',
    '#community_users_invited_to_poll_not_compiled' => 'Only invited community participants who have not yet filled out the survey',

    '{attribute} must be greater than or equal to "{dateFormatter}".' => '{attribute} must be greater than or equal to "{dateFormatter}".',
];
