...
//\yii\helpers\VarDumper::dump($post,4,true);die;
    ...
    <div class="it-grid-item-wrapper p-2">
        <div class="p-3">
            ...
            <?php if (!empty($showPostCheckboxes)) : ?>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <div class="insta_logo text-right pb-3 px-0">
                <span class="icon icon-lg instagram mdi mdi-36px mdi-instagram"></span>
            </div>
            <div class="img-responsive-wrapper">
                <div class="img-responsive">
                    <div class="img-wrapper">
                        <?php
                            switch ($modelOrTemplate('media_type')) {
                                case "IMAGE":
                                    echo '<img src="' . htmlspecialchars_decode($modelOrTemplate('post_image_url')) . '">';
                                    break;
                                case "VIDEO":
                                    echo '<video width="100%" controls loop><source src="' . htmlspecialchars_decode($modelOrTemplate('post_image_url')) . '" type="video/mp4"/></video>';
                                    break;
                                default:
                                    echo '<img src="' . htmlspecialchars_decode($modelOrTemplate('post_image_url')) . '">';
                                    break;
                        ...
                        ?>
<!--                        <img src="--><?php //= htmlspecialchars_decode($modelOrTemplate('post_image_url')); ?><!--">-->
                    </div>
                </div>
            </div>
