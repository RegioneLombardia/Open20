 ...
 * SocialwallPostsController implements the CRUD actions for SocialwallPosts model.
 *
 * @property \open20\socialwall\models\SocialwallPosts $model
 * @property \open20\socialwall\models\search\SocialwallPostsSearch $modelSearch
 *
 * @package open20\socialwall\controllers\base
 */
class SocialwallPostsController extends CrudController
{
...
//    public $layout = 'list';
    ...
    {
        $this->setModelObj(new SocialwallPosts());
        $this->setModelSearch(new SocialwallPostsSearch());
    ...
    /**
     * Lists all SocialwallPosts models.
     * @return mixed
     */
    ...
    /**
     * Displays a single SocialwallPosts model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new SocialwallPosts model.
    ...
    public function actionCreate()
    {
        ...
        $this->model = new SocialwallPosts();
    ...
    /**
     * Creates a new SocialwallPosts model by ajax request.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
...
//Yii::$app->getSession()->addFlash('danger', BaseAmosModule::t('amoscore', 'Item not created, check data'));
    ...
    /**
     * Updates an existing SocialwallPosts model.
    ...
    /**
     * Deletes an existing SocialwallPosts model.
