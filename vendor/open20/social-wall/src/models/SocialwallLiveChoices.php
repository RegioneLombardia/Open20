...
/**
 * This is the model class for table "socialwall_live_choices".
 */
class SocialwallLiveChoices extends \open20\socialwall\models\base\SocialwallLiveChoices implements
...
//inserire il campo o i campi rappresentativi del modulo
    ...
    public function getEditFields()
    {
        ...
        return [
            ...
            [
                'slug' => 'socialwall_tokens_id',
                'label' => $labels['socialwall_tokens_id'],
                'type' => 'integer'
            ],
            [
                'slug' => 'keywords',
