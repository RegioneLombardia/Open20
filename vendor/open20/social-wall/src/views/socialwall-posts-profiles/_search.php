...
* @var open20\socialwall\models\SocialwallPostsProfilesSearch $model
* @var yii\widgets\ActiveForm $form
*/


?>
<div class="socialwall-posts-profiles-search element-to-toggle" data-toggle-element="form-search">
...
<!-- profile_name -->
<div class="col-md-4"> <?= 
$form->field($model, 'profile_name')->textInput(['placeholder' => 'ricerca per profile name' ]) ?>

 </div> 

<!-- profile_url -->
<div class="col-md-4"> <?= 
$form->field($model, 'profile_url')->textInput(['placeholder' => 'ricerca per profile url' ]) ?>
