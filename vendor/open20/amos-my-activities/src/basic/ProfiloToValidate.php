 ...
 * @package open20\amos\myactivities\basic
 */
class ProfiloToValidate extends \open20\amos\organizzazioni\models\search\ProfiloSearch implements MyActivitiesModelsInterface
{
    /**
     * @return string
     */
    ...
    {
        return Profilo::findOne($this->id);
    }
    ...
    {
        return 'organizzazioni/profilo/view';
    }
}
