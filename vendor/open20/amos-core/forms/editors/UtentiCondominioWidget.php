...
class UtentiCondominioWidget extends Widget {
    ...
    public function renderItemsMittente() {
        return AmosGridView::widget([
            ...
            public function renderItemsTarget() {
                ...
                $Grid = $this->getView()->renderFile('@backend/modules/admin/views/user-profile/associa_utenti_condominio_grid.php', [
