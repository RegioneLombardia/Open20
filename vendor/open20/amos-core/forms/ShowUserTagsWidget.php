...
class ShowUserTagsWidget extends Widget
{
    ...
    /**
     * Custom root tags to show
     * @var array $customRootTags
     */
    public $customRootTags = [];
    ...
    protected function getArrayTagsId()
    {
        ...
        if($this->className == $userProfileClass){
            ...
            if (!empty($this->customRootTags)) {
                $listaTagId = $listaTagId->andWhere(['root_id' => $this->customRootTags]);
            }
            $listaTagId = $listaTagId->orderBy([
                    'tag.nome' => SORT_DESC
                ])->all();
        }
...
//                    'classname' => $this->className,
            ...
            if (!empty($this->customRootTags)) {
                $tagIdList = $tagIdList->andWhere(['root_id' => $this->customRootTags]);
            }
