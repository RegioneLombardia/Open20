...
class ConfiguratorSocialShare extends Configurator
{
    ...
    public function initDeafaultOption()
    {
        ...
        $twitterBrand = !empty(\Yii::$app->params['twitter-x-enabled']) ? 'mdi-twitter-x-brand' : 'mdi-twitter';
        ...
        if (empty($this->socialNetworks)) {
            $this->socialNetworks = [
                ...
                'twitter' => [
                    ...
                    'label' => \yii\helpers\Html::tag('span', '',
                        ['class' => 'mdi mdi-2 ' . $twitterBrand, 'title' => BaseAmosModule::t('amoscore', 'Share with twitter')]),
