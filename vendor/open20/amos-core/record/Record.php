...
class Record extends ActiveRecord implements StatsToolbarInterface, CrudModelInterface
{
    ...
    public function setOrderVars($params)
    {
        ...
        if (
            ...
            array_key_exists("orderAttribute", !empty($params[$classSearch]) ? $params[$classSearch] : []) &&
            array_key_exists("orderType", !empty($params[$classSearch]) ? $params[$classSearch] : [])
        ) {
    ...
    public function beforeValidate()
    {
        ...
        if ($enablePurifyDataParam == true) {
            ...
            foreach ($listAttributes as $attribute => $value) {
                ...
                if (is_string($this->$attribute)) {
                    $this->$attribute = StringHelper::purifyString($this->$attribute, $isStrict);
                }
