...
/**
 * This is the model class for table "user_lockout".
 *
 * @property integer $id
 ...
 * @property User $user
 */
class UserLockout extends AmosRecordAudit
{
    const ACCESSS_ATTEMPTS_LOCKOUT_DEFAULT = 5;
    const ACCESSS_TIME_LOCKOUT_DEFAULT = 24; // Hours
