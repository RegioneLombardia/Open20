...
class m201105_170900_add_columns_agid_to_documenti extends Migration
{
    ...
    public function up()
    {
        ...
        $this->addColumn( 'documenti', 'distribution_license', $this->text()->null()->defaultValue(null)->comment('Distribution proscription') );
    ...
    public function down()
    {
        ...
        $this->dropColumn('documenti', 'distribution_license');
