...
class WidgetIconSpool extends WidgetIcon
{
    ...
    public function init()
    {
        ...
        $this->setLabel(AmosEmail::tHtml('amosemail', 'Spool'));
        $this->setDescription(AmosEmail::t('amosemail', 'Spool Widget'));
        $this->setIcon('envelope-o');
        $this->setUrl(Yii::$app->urlManager->createUrl(['email/spool']));
