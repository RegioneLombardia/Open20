 ...
 *
 *
 * @package    open20\amos\moodle\i18n\en-US
 * @category   CategoryName
 */

return [
    '#dont_reply' => '*** This is an automatically generated email, please do not reply ***',
    '#courses' => 'Courses',
    '#image' => 'Image',
    ...
    '#ok_iscrizione_corso' => 'Now you can register for the training course and participate in training activities and in-depth discussions.',
    '#iscrivimi' => 'Sign me up!',
    '#warning' => 'Warning!',
    '#gentle_user' => 'Gentle user',
    '#gentle_user_name_surname' => 'Gentle {nome} {cognome},',

    '#not_public_course' => 'this course has not public signing up.',
    '#need_subscription_request' => "Registration for the course must be requested.",
    '#request_subscription' => 'Request registration',
    '#subscription_already_request' => "If you have already requested registration, you will receive a confirmation email after registration.",
    ...
    '#paypal_course' => 'Dear user, a payment of {pp_cost} {pp_currency} is required to access the course content.',
    '#need_to_pay' => 'Click on the “Buy course” button to proceed with the payment.',
    '#paypal_payment_btn' => 'Buy course',
