...
<div class="box-widget-header">
    ...
    if (isset($moduleEvents) && !$moduleEvents->hideWidgetGraphicsActions) {
        WidgetGraphicsActions::widget([
            ...
            'actionRoute' => '/events/wizard/create',
    ...
    <div class="box-widget-wrapper">
        <h2 class="box-widget-title">
            ...
            <?= AmosEvents::tHtml('amosevents', 'Eventi a cui sono iscritto') ?>
        </h2>
    </div>
    ...
    if ($thereAreEvents) {
        ...
        $linkReadAll = ['/events/event-dashboard/my-events'];
        $checkPermNew = false;
    } else {
...
<div class="box-widget latest-events">
    <section>
        <h2 class="sr-only"><?= AmosEvents::t('amosevents', 'Eventi a cui sono iscritto') ?></h2>
        <div class="wrap-event">
            <div class="<?= ($thereAreEvents ? 'col-sm-8' : '') ?> col-xs-12 nop" id="event-calendar-pjax">
                ...
                <?php else: ?>
                    ...
                    $configuration = [
                        'containerOptions' => [
                            'id' => 'eventsOwlCarouselRegistered'
                        ],
                        'pluginOptions' => [
                            'autoplay' => true,
                            'items' => 1,
                    ...
                    <?php foreach ($eventsForCarousel as $event): ?>
                        ...
                        <div>
                            <a target="_blank" href="<?= \open20\amos\events\utility\EventsUtility::getUrlLanding($event) ?>" title="<?= AmosEvents::t('amosevents', '#widget_title_view_event') ?>">
                                <div class="wrap-img">
                                    <?=
