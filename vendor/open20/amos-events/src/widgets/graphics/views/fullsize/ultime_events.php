...
$isNewWizard = $moduleEvents->enableNewWizard;
...
<div class="box-widget-header">
    ...
    <div class="box-widget-wrapper">
        <h2 class="box-widget-title">
            ...
            <?= AmosEvents::tHtml('amosevents', 'Events of interest') ?>
        </h2>
    </div>
...
<div class="box-widget latest-events">
    <section>
        <h2 class="sr-only"><?= AmosEvents::t('amosevents', 'Events of interest') ?></h2>
                ...
                <?php else: ?>
                    ...
                    <?php foreach ($eventsForCarousel as $event): ?>
                        ...
                        <div>
                            ...
                            $attr = '';
                            if($isNewWizard){
                                $url = \open20\amos\events\utility\EventsUtility::getUrlLanding($event);
                                $attr = 'target="_blank"';
                            }
                            else {
                                $url = $event->getFullViewUrl();
                            }
                            ?>
                            <a <?= $attr ?> href="<?= $url?>" title="<?= AmosEvents::t('amosevents', '#widget_title_view_event') ?>">
                                <div class="wrap-img">
                                    <?=
