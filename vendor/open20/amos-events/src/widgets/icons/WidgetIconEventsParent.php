 ...
 * @package open20\amos\news\widgets\icons
 */
class WidgetIconEventsParent extends WidgetIcon
{
    /**
     * @inheritdoc
     */
    public function init()
    {
        ...
        $this->setLabel(AmosEvents::tHtml('amosevents', 'Eventi Padre'));
        ...
        $this->setUrl(['/events/event-container/index']);
...
//        }
    ...
    public function isVisible()
    {
        ...
        if($module){
            if($module->enableEventContainer == true){
                return true;
            }
        }
        return false;
