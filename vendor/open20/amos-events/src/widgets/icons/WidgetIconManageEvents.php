 ...
 * @package open20\amos\news\widgets\icons
 */
class WidgetIconManageEvents extends WidgetIcon
{
    /**
     * @inheritdoc
     */
    public function init()
    {
        ...
        $this->setLabel(AmosEvents::tHtml('amosevents', 'Gestisci i miei eventi'));
        ...
        $this->setUrl(['/events/event-dashboard/manage-events']);
