 ...
 * @package open20\amos\news\widgets\icons
 */
class WidgetIconManageAllEvents extends WidgetIcon
{
    /**
     * @inheritdoc
     */
    public function init()
    {
        ...
        $this->setLabel(AmosEvents::tHtml('amosevents', 'Gestisci tutti gli eventi'));
        ...
        $this->setUrl(['/events/event-dashboard/manage-all-events']);
