 ...
 * @package open20\amos\news\widgets\icons
 */
class WidgetIconCreateNewEvent extends WidgetIcon
{
    /**
     * @inheritdoc
     */
    public function init()
    {
        ...
        $this->setLabel(AmosEvents::tHtml('amosevents', 'Crea nuovo evento'));
        $this->setDescription(AmosEvents::t('amosevents', 'Crea nuovo evento'));
