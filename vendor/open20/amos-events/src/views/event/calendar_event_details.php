...
<div class="event-detail-modal">
    ...
    <?php
    if($model->eventType->event_type == \open20\amos\events\models\EventType::TYPE_OPEN || $model->eventType->event_type_id == \open20\amos\events\models\EventType::TYPE_LIMITED_SEATS) {
