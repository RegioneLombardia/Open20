...
* @var open20\amos\events\models\search\EventLocationEntrancesSearch $model
* @var yii\widgets\ActiveForm $form
*/


?>
<div class="event-location-entrances-search element-to-toggle" data-toggle-element="form-search">
 ...
 <!-- event_location_id -->
<div class="col-md-4"> <?= 
$form->field($model, 'event_location_id')->textInput(['placeholder' => 'ricerca per event location id' ]) ?>
                ...
                <div class="col-md-4">
                    <?= 
                    $form->field($model, 'eventLocation')->textInput(['placeholder' => 'ricerca per '])->label('');
                     ?> 
                </div>
                <!-- name -->
<div class="col-md-4"> <?= 
