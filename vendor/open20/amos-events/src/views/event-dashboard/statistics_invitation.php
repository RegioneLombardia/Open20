...
<div class="col-md-12">
    ...
    <p><strong><?= AmosEvents::t('amosevents','Lista di invio').': '?></strong><?= $model->name ?></p>
    <p><strong><?= AmosEvents::t('amosevents','template').': '?></strong><?= $model->template ?></p>
...
<div class="col-md-12">
    <?php
    echo \yii\helpers\Html::a(AmosEvents::t('amosevents', 'Back'), ['invite', 'id' => $event->id], ['class' => 'btn btn-primary']);
    ?>
</div>
