...
?>
<div class="event-location-search element-to-toggle" data-toggle-element="form-search">
...
<!-- event_place_id -->
<div class="col-md-4"> <?= 
$form->field($model, 'event_place_id')->textInput(['placeholder' => 'ricerca per event place id' ]) ?>
