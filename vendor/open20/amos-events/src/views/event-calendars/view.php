    ...
    <div class="col-xs-12 nop event-calendars-view">
        ...
        <div class="col-xs-12 nop m-b-25">
            ...
            <div class="col-xs-12 col-sm-4 col-md-2">
                ...
                <h3 class="m-t-0"><?= $model->slot_duration . ' min.' ?></h3>
            </div>
            ...
            <?= \open20\amos\core\views\AmosGridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'hour_end',
                        'value' => function ($model) {
                            return \Yii::$app->formatter->asTime($model->hour_end, 'php:H:i');
                        }
                    ],
                    ...
                    [
                        ...
                        'value' => function ($model) use ($canViewUser){
                            ...
                            return (!empty($model->user_id) ? (AmosEvents::t('amosevents',
                                    'Prenotato') . (!empty($user) ? ' ' . AmosEvents::t('amosevents',
                                        'da') . ' ' . $user : '')) : AmosEvents::t('amosevents', 'Libero'));
                        },
