...
use open20\amos\events\models\search\EventGroupReferentSearch;
...
/**
 * Class EventGroupReferentController
 * EventGroupReferentController implements the CRUD actions for EventGroupReferent model.
 *
 * @property \open20\amos\events\models\EventGroupReferent $model
 * @property \open20\amos\events\models\search\EventGroupReferentSearch $modelSearch
 *
 * @package open20\amos\events\controllers\base
 */
class EventGroupReferentController extends CrudController
{
    ...
    {
        $this->setModelObj(new EventGroupReferent());
        $this->setModelSearch(new EventGroupReferentSearch());
    ...
    /**
     * Lists all EventGroupReferent models.
     * @return mixed
     */
    ...
    /**
     * Displays a single EventGroupReferent model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new EventGroupReferent model.
    ...
    public function actionCreate()
    {
        ...
        $this->model = new EventGroupReferent();
    ...
    /**
     * Creates a new EventGroupReferent model by ajax request.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
...
//Yii::$app->getSession()->addFlash('danger', Yii::t('amoscore', 'Item not created, check data'));
    ...
    /**
     * Updates an existing EventGroupReferent model.
    ...
    /**
     * Deletes an existing EventGroupReferent model.
