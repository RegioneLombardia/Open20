 ...
 * EventCalendarsSlotsController implements the CRUD actions for EventCalendarsSlots model.
 *
 * @property \open20\amos\events\models\EventCalendarsSlots $model
 * @property \open20\amos\events\models\search\EventCalendarsSlotsSearch $modelSearch
 *
 * @package open20\amos\events\controllers\base
 */
class EventCalendarsSlotsController extends CrudController
{
    ...
    /**
     * Lists all EventCalendarsSlots models.
     * @return mixed
     */
    ...
    /**
     * Displays a single EventCalendarsSlots model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new EventCalendarsSlots model.
    ...
    /**
     * Creates a new EventCalendarsSlots model by ajax request.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
...
//Yii::$app->getSession()->addFlash('danger', Yii::t('amoscore', 'Item not created, check data'));
    ...
    /**
     * Updates an existing EventCalendarsSlots model.
    ...
    /**
     * Deletes an existing EventCalendarsSlots model.
