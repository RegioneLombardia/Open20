...
* @var backend\modules\operators\models\AgidPersonContentTypeSearch $model
* @var yii\widgets\ActiveForm $form
*/


?>
<div class="agid-person-content-type-search element-to-toggle" data-toggle-element="form-search">
 ...
 <!-- deleted_by -->  <?php // echo $form->field($model, 'deleted_by') ?>
     ...
     <div class="col-xs-12">
        <div class="pull-right">
            <?= Html::resetButton(Yii::t('amoscore', 'Reset'), ['class' => 'btn btn-outline-primary']) ?>
