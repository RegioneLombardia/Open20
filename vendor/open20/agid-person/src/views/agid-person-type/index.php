 ...
 * @var backend\modules\operators\models\AgidPersonTypeSearch $model
 */

$this->title = Yii::t('amoscore', 'Tipologia Persona');
$this->params['breadcrumbs'][] = ['label' => '', 'url' => ['/person']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="agid-person-type-index">
    ...
    <?= DataProviderView::widget([
        ...
        'gridView' => [
            ...
            'toolbar' =>  [],
            'panel' => [
                'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-globe"></i> Tipologia persone</h3>',
                'type'=>'default',
