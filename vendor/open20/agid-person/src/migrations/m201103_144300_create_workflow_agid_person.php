...
/**
 * Class m201103_144300_create_workflow_agid_person
 */
class m201103_144300_create_workflow_agid_person extends AmosMigrationWorkflow
{
    ...
    private function workflowStatusConf()
    {
        return [
            [
                ...
                'id' => 'DRAFT',
                'workflow_id' => self::AGID_PERSON_WORKFLOW,
                'label' => 'Bozza',
                'sort_order' => '0'
            ],
            [
