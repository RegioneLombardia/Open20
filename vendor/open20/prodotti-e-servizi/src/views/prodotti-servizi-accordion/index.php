...
$this->title = Yii::t('amoscore', 'Accordion dinamici');
$this->params['breadcrumbs'][] = ['label' => '', 'url' => ['/prodottiservizi']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="prodotti-servizi-accordion-index">
    ...
    <?= DataProviderView::widget([
        ...
        'gridView' => [
            'columns' => [
                ...
                'prodottiServizi' => [
                    'attribute' => 'prodottiServizi',
                    'format' => 'html',
                    'label' => '',
                    'value' => function ($model) {
                        return strip_tags($model->prodottiServizi);
                    }
                ],
                [
