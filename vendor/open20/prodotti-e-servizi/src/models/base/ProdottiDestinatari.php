...
/**
 * This is the base-model class for table "prodotti_destinatari".
 *
 * @property integer $id
 ...
 */
abstract class ProdottiDestinatari extends \open20\amos\core\record\Record
{
    ...
    {
        return [
            [['name', 'parent', 'icon'], 'required'],
            [['parent', 'created_by', 'updated_by', 'deleted_by'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'parent' => Yii::t('prodottiservizi', 'Scope'),
