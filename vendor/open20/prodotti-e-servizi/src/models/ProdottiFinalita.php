...
/**
 * This is the model class for table "prodotti_finalita".
 */
class ProdottiFinalita extends \open20\prodottiservizi\models\base\ProdottiFinalita implements
    SearchModelInterface
{
    ...
    /**
     * @return ProdottiServiziFinalitaMm[]
     * @throws \yii\base\InvalidConfigException
     */
    public function getProdottiSingle()
    {
        $query2 = ProdottiServiziFinalitaMm::find()
            ->select('prodotto_id')
            ->andWhere(['!=', 'finalita_id', $this->id]);
    ...
    {
        $query = ProdottiServiziFinalitaMm::find()
            ->joinWith('prodotto')
            ->andWhere(['finalita_id' => $this->id])
            ->andWhere(['id_product_root' => null])
            ->count();
