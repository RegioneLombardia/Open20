...
use open20\prodottiservizi\models\search\ProdottiSoluzioniSearch;
...
/**
 * Class ProdottiSoluzioniController
 * ProdottiSoluzioniController implements the CRUD actions for ProdottiSoluzioni model.
 *
 * @property \open20\prodottiservizi\models\ProdottiSoluzioni $model
 * @property \open20\prodottiservizi\models\search\ProdottiSoluzioniSearch $modelSearch
 *
 * @package open20\prodottiservizi\controllers\base
 */
class ProdottiSoluzioniController extends CrudController
{
    ...
    {
        $this->setModelObj(new ProdottiSoluzioni());
        $this->setModelSearch(new ProdottiSoluzioniSearch());
    ...
    /**
     * Lists all ProdottiSoluzioni models.
     * @return mixed
     */
    ...
    /**
     * Displays a single ProdottiSoluzioni model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new ProdottiSoluzioni model.
    ...
    public function actionCreate()
    {
        ...
        $this->model = new ProdottiSoluzioni();
    ...
    /**
     * Creates a new ProdottiSoluzioni model by ajax request.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
...
//Yii::$app->getSession()->addFlash('danger', BaseAmosModule::t('amoscore', 'Item not created, check data'));
    ...
    /**
     * Updates an existing ProdottiSoluzioni model.
    ...
    /**
     * Deletes an existing ProdottiSoluzioni model.
