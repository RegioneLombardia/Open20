 ...
 * This is the class for controller "ProdottiSoluzioniController".
 * @package open20\prodottiservizi\controllers
 */
class ProdottiSoluzioniController extends \open20\prodottiservizi\controllers\base\ProdottiSoluzioniController
{
    /**
     * @inheritdoc
     */
    public function beforeAction($action)
    {
        ...
        if (\Yii::$app->user->isGuest) {
            $titleSection = Module::t('amosdashboards', 'Soluzioni');
            $urlLinkAll   = '';
            ...
            $titleSection = Module::t('amosdashboards', 'Gestisci Soluzioni');
        ...
        $urlCreate   = '/prodotti-e-servizi/prodotti-soluzioni/create';
        $urlManage   = null;
