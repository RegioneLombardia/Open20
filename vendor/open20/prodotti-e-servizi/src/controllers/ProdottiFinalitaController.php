 ...
 * This is the class for controller "ProdottiFinalitaController".
 * @package open20\prodottiservizi\controllers
 */
class ProdottiFinalitaController extends \open20\prodottiservizi\controllers\base\ProdottiFinalitaController
{
    /**
     * @inheritdoc
     */
    public function beforeAction($action)
    {
        ...
        if (\Yii::$app->user->isGuest) {
            $titleSection = Module::t('amosdashboards', 'finalità');
            $urlLinkAll   = '';
            ...
            $titleSection = Module::t('amosdashboards', 'Gestisci finalità');
        ...
        $titleManage = Module::t('amosdashboards', 'Gestisci le finalità');
        $urlCreate   = '/prodotti-e-servizi/prodotti-finalita/create';
        $urlManage   = null;
