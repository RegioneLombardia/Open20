...
return [
    ...
    'ACTIVE' => 'Active',
    'Accetta' => 'Accept',
    'Accetta invito di iscrizione alla community' => 'Accept invitation to join the community',
    ...
    'Descrizione' => 'Description',
    "Devi essere validato per poter effettuare l'iscrizione alla community" => "You must be validated in order to register for the community",
    ...
    'Disiscriviti dalla community' => 'Unsubscribe from the community',
    ...
    'e alla community come' => 'and to the community as',
    'Edit' => 'Edit',
    ...
    'Invita Utenti Esterni' => 'Invite Esternal users',
    'Invita Utenti Interni' => 'Invite internal users',
    ...
    'Iscriviti' => 'Register',
    'Iscritto il' => 'Joined on',
    'is now ' => 'is now',
    'is now' => 'is now',
    'Iscriviti alla community' => 'Join the community',
    ...
    'Rifiuta' => 'Decline',
    'Rifiuta invito di iscrizione alla community' => 'Decline invitation to join the community',
    ...
    'sottocommunity di:' => 'subcommunity of:',
    'Stato' => 'Status',
    'Status' => 'Status',
    ...
    'User' => 'User',
    'Utente' => 'User',
    'Vai alla community principale' => 'Go to the main community',
    ...
    'Visualizza le community create da me' => 'View all communities I have created',
    'Visualizza le community da validare' => 'View all communities to validate',
    'Amministra tutte le community' => 'Manage all communities',
    'Visualizza la lista delle mie community' => 'Show my Communities',
    'Visualizza la lista delle community' => 'Show communities',
    'Visualizza' => 'View',
    ...
    '#widget_icon_community_dashboard_description' => 'Community module',
    ...
    "#beforeActionSubtitleSectionGuest" => "Co-creation for the generation of new ideas: communities are one of the characteristic tools of this platform. Through dedicated work groups, {platformName} initiatives create spaces for collaboration, innovation, sharing and networking.<br><br>If you want to access the contents of the {platformName} {ctaLoginRegister} communities",
    "#beforeActionSubtitleSectionLogged" => "Co-creation for the generation of new ideas: communities are one of the characteristic tools of this platform. Through dedicated work groups, {platformName} initiatives create spaces for collaboration, innovation, sharing and networking.",
    'Non hai il permesso per creare sottocommunity' => 'You have not permissions to create a subcommunity',
    'Sei sicuro di trasformare la sottocommunity in community?' => 'Are you sure to trasform the subcommunity to a community?',
    'Sei iscritto alla community come' => 'You are registered to the community as',
    'Trasforma in community' => 'Transform to community',
    "Sposta sotto un'altra community" => 'Move community under an other community',
    "Sposta" => 'Move',
    "Nuova" => 'New',
    "Visita la community" => 'Visit the community',
    "Crea una nuova community" => 'Create a community',
    "Gestisci" => 'Manage',
    "Gestisci le community" => 'Manage communities',
    "Qui troverai le community della piattaforma {platformName} a cui sei iscritto." => "Here you will find the communities of the platform {platformName} in which you are subscribed.",
    "Visualizza community da validare" => "Show community to validate",
    "Da validare" => "To validate",
    "Amministra" => "Manage",
    "Tutte" => "All",
    "Visualizza tutte le community" => "Show all communities",
    "Tutte le community a cui partecipi" => "All communities in which you partecipate",
    "Visualizza la lista delle community a cui partecipi" => "Show all communities in which you partecipate",
    "Sottocommunity da validare" => "Subcommunities to validate",
    "Qui troverai le sottocommunity della community \"{parent_community}\" da validare." => "Here you will find the subcommunities of \"{parent_community} \" community to be validated.",
    "Le mie sottocommunity" => "My subcommunities",
    "Qui troverai le sottocommunity a cui sei iscritto, della community \"{parent_community}\"." => "Here you will find the subcommunities to which you are subscribed, of the community \"{parent_community}\".",
    "Sottocommunity create da me" => "Subcommunities created by me",
    "Qui troverai le sottocommunity che hai creato nella community \"{parent_community}\"." => "Here you will find the subcommunities you created in the \"{parent_community}\" community.",
    ...
    'Potrai pubblicare il bookmark in seguito' => 'You will be able to publish the bookmark later',
    'Salva e mantieni lo stato attuale' => 'Save and keep current status',
    'Elenco dei partecipanti alla community' => 'List of community members'
