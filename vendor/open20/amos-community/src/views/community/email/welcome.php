...
<div>
    <div style="box-sizing:border-box;">
        <div style="padding:5px 10px;background-color: #F2F2F2;">
            <h1 style="color:#297A38;text-align:center;font-size:1.5em;margin:0;"><?= AmosCommunity::t('amoscommunity', '#welcome_mail_title') ?></h1>
        </div>
        <div
            style="border:1px solid #cccccc;padding:10px;margin-bottom: 10px;background-color: #ffffff; margin-top: 20px;">
            <h2 style="font-size:2em;line-height: 1;"><?= AmosCommunity::t('amoscommunity', '#welcome_mail_text_1') . $util->contextLabel ?></h2>
            ...
            <div style="width:100%;margin-top:30px">
                <p>
                    <?= AmosCommunity::t('amoscommunity', "Your role is: ") ?>
