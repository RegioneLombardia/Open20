      ...
      <div class="card-body border-bottom border-light px-0">
        <div class="d-flex flex-column flex-md-row">
          <div class="date-list mb-1">
            <div class="date-start d-flex flex-sm-row flex-md-column flex-lg-column text-center text-uppercase h-100 justify-content-center border-primary">
          ...
          <?php if($image): ?>
            <div class="image-list mb-1 object-fit">
              <img src="<?= $image ?>" alt="<?= Module::t('amosdesign', '#survey_image') ?>" class="community-image img-fluid w-100 mh-100" />
            </div>
          <?php endif; ?>

          <div class="description-list col mb-1 d-flex align-items-start flex-column pl-3">
            ...
            <div class="footer-list d-flex mt-auto bd-highlight w-100">  
              <div class="pool-status mt-2 d-flex justify-content-between flex-row flex-md-column flex-lg-row text-uppercase w-100">
                  ...
                  <a class="read-more position-relative w-auto" href="<?= $url ?>" title="<?= $titleReadMore ?>">
